      ...
      <div className="container mx-auto relative z-10">
        <div className="glass-card rounded-2xl p-4 md:p-8 max-w-4xl mx-auto">
          ...
          <p className="text-base md:text-xl text-gray-300 mb-6 md:mb-8 leading-relaxed">
            I am a first-year Master’s student in Computer Engineering (Algorithms and Computation) at Sharif University of Technology with a passion for Bioinformatics, particularly Genomics and protein folding. I have a proven track record as a teaching assistant for courses such as Logic Circuits and Computer Architecture. I have also actively contributed to the success of the ICPC prep classes. Beyond academics, I find joy in dancing and believe that creativity and problem-solving are essential in both personal and professional pursuits. 
          </p>
